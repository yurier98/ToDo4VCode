...
import { WebviewMessage, ConfigReadyMessage, UpdateConfigMessage, ExportDataMessage, ImportDataMessage, ClearAllDataMessage, PromptSharedTasksPathMessage } from '../../core/models/webview-messages';
...
export class WebviewMessageRouter {
    ...
    public async handleMessage(
        ...
        if (msg.type === 'configReady' || msg.type === 'updateConfig' || msg.type === 'exportData' || msg.type === 'importData' || msg.type === 'clearAllData' || msg.type === 'promptSharedTasksPath') {
            await this._configHandler.process(
                message as ConfigReadyMessage | UpdateConfigMessage | ExportDataMessage | ImportDataMessage | ClearAllDataMessage | PromptSharedTasksPathMessage,
                webview
            );
            return;
        }
